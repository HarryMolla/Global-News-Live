      ...
      <div className="relative justify-center items-center grid gap-0 overflow-visible">
        ...
        >
          <img
            src={image}
            alt="Harry"
            className="md:w-70 md:h-70 w-40 h-40 rounded-full relative z-10  md:-mt-10 -mt-30"
          />
        ...
        <GradientText
          className="text-2xl font-medium text-center mr-5 ml-5 md:mb-3 md:-mt-15 -mt-12"
